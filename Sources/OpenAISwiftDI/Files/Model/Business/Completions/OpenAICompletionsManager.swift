...
public actor OpenAICompletionsManager: InjectionKey {
    ...
    public func makeCompletionsCallStream(parameters: CompletionsRequest,
                                          array: Binding<[CompletionsResponse]>) async throws {
    ...
    /// https://platform.openai.com/docs/api-reference/completions
    public func makeCompletionsCallStream(parameters: CompletionsRequest) async throws ->
    ...
    func makeChatCompletionsCall(parameters: ChatCompletionRequest,
                                 latestMessage: ChatMessage) async throws ->
